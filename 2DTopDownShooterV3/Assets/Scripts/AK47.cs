...
public class AK47 : MonoBehaviour
{
    ...
    public int bulletDamage = 30; // Daño del proyectil
    ...
    public int maxBullets = 40; // Cantidad máxima de balas
    ...
    public bool isFiring; // Indica si se está disparando
    ...
    {
        // Disparar continuamente mientras se mantiene presionado el botón de disparo
        while (isFiring)
        {
            Shoot();
